...
def parse_args(make_dirs=True):
    ...
    parser.add_argument('--lr_decay', nargs='+', default=[90, 150], type=int, help='Epoch to learning rate decay')
    parser.add_argument("--warmup", type=int, default=5, help="Epochs for warming up training")
    parser.add_argument("--init_lr", type=float, default=0.00001, help="Learning rate for inital training")
